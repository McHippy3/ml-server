...
def forecast():
    ...
    #Reading data
    df_sales = pd.read_csv('./time_series/rossmann-data/train.csv', dtype={'StateHoliday':str, 'SchoolHoliday':str})
    ...
    plt.savefig('time_series/images/rossmann_all_data.png')
    ...
    plt.savefig('time_series/images/predicted_vs_actual_all.png')